...
<div class="jumbotron-head"><a href="<?php echo $SITE_URL; ?>"></a></div>
<div class="jumbotron-content">
<h2>Для работы с сайтом необходима поддержка JavaScript и Cookies.</h2>
<div>
Чтобы использовать все возможности сайта, загрузите и установите один из этих браузеров:
<div class="good_browsers"><a href="https://browser.yandex.ru/desktop/main/" target="_blank" class="good_browser"><div class="browser_icon yandex"></div>Яндекс</a><a href="https://www.google.ru/intl/ru/chrome/browser/desktop/" target="_blank" class="good_browser"><div class="browser_icon chrome"></div>Chrome</a><a href="https://www.mozilla.org/ru/firefox/new/" target="_blank" class="good_browser"><div class="browser_icon firefox"></div>Firefox</a><a href="http://www.opera.com/ru" target="_blank" class="good_browser"><div class="browser_icon opera"></div>Opera</a></div>
</div>
</div>
</div>
</div>
